...
Configuration is a recommended way to declare properties that can be used later in installations and tests. Configuration is immutable and the only way it can be changed is from commandline.
+
[source,groovy]
----
configuration {

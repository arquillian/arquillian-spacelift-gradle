...
clean::
    Executes _cleanInstallations_, _cleanRepository_ and _cleanWorkspace_ tasks in this order.
cleanInstallations::
    Deletes directory where you cache installations
cleanRepository::
    Deletes _.repository_ directory in your workspace
cleanWorkspace::

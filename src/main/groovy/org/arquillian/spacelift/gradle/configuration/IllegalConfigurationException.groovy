...
public class IllegalConfigurationException extends IllegalStateException {
    ...
    public static IllegalConfigurationException incompatibleOverride(ConfigurationItem<?> mainItem,
                                                                     ConfigurationItem<?> profileItem) {
        return new IllegalConfigurationException("Profile configuration tried to override `${mainItem.name}`, but " +
